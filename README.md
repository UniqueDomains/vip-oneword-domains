...
<p align="left">
  ...
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C715%20rows-8250df">
...
> **Important:** this repository is a **public 7,715-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,097 domains** on the canonical page below.

**Public extract:** 7,715 rows · **Live catalog:** 5,622,097 domains
...
- `vip.csv` — public CSV extract (7,715 rows)
- `vip.json` — public JSON extract (7,715 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,715-row public sample | 5,622,097 live domains                           |
...
> Unique Domains. *Available .VIP One-Word Domains*. Version 2026-04-10. Public GitHub extract for the exact Unique Domains search represented by this repository.
