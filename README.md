...
**Public extract:** 7,724 rows · **Live catalog:** 7,722 domains
...
- `vip.csv` — public CSV extract (7,724 rows)
- `vip.json` — public JSON extract (7,724 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,724-row public sample | 7,722 live domains                               |
...
> Unique Domains. *Available .VIP One-Word Domains*. Version 2026-04-12. Public GitHub extract for the exact Unique Domains search represented by this repository.
