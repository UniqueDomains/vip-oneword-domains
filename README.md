# Available .VIP One-Word Domains (5,622,097)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-7%2C712%20rows-8250df">
...
> **Important:** this repository is a **public 7,712-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,622,097 domains** on the canonical page below.

**Public extract:** 7,712 rows · **Live catalog:** 5,622,097 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/vip?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/vip?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./vip.csv">CSV</a> / <a href="./vip.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .VIP search](https://unique.domains/domains/tld/vip?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .VIP search](https://unique.domains/domains/tld/vip?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_vip_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./vip.csv) or [Download JSON](./vip.json)
...
- `vip.csv` — public CSV extract (7,712 rows)
- `vip.json` — public JSON extract (7,712 rows)
...
| ----------------------- | ------------------------------------------------ |
| 7,712-row public sample | 5,622,097 live domains                           |
...
| moveon.vip    | available | $10.98    | —             | 72             | 13     | 7      | namecheap                                               |
...
| law.vip       | premium   | $6,500    | $16.90        | 82             | 48     | 3      | namecheap                                               |
...
> Unique Domains. *Available .VIP One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
